...
#include "../../src/Clases/ProcessingThread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ProcessingThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 37, 5)
    ...
    "ProcessingThread\0new_info\0\0new_frame\0"
    "frame\0"
};
...
void ProcessingThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->new_info((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->new_frame((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ProcessingThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProcessingThread::new_info)) {
                *result = 0;
            }
        }
        {
            typedef void (ProcessingThread::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProcessingThread::new_frame)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ProcessingThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ProcessingThread.data,
      qt_meta_data_ProcessingThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProcessingThread.stringdata))
...
// SIGNAL 0
void ProcessingThread::new_info(QString _t1)
{
...
// SIGNAL 1
void ProcessingThread::new_frame(const QImage & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
