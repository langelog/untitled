...
#include "../src/Clases/CaptureThread.h"
...
QT_MOC_LITERAL(3, 24, 12)
    ...
    "CaptureThread\0new_info\0\0inform_usage\0"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->inform_usage((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureThread::new_info)) {
                *result = 0;
            }
        }
        {
            typedef void (CaptureThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CaptureThread::inform_usage)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void CaptureThread::new_info(QString _t1)
{
...
// SIGNAL 1
void CaptureThread::inform_usage(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
